    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateCartCount() {
                ...
                // Lấy tất cả các dòng giỏ hàng và tính tổng số lượng
                document.querySelectorAll('.quantity-input').forEach(input => {
                    cartCount += parseInt(input.value); // Thêm số lượng vào tổng
                });
            ...
            document.querySelectorAll('.quantity-input').forEach(input => {
                input.addEventListener('change', function() {
                    ...
                    const maxQuantity = parseInt(row.getAttribute(
                        'data-stock')); // Giới hạn tối đa trong kho

                    // Kiểm tra nếu số lượng vượt quá số lượng trong kho
                    if (newQuantity > maxQuantity) {
                        alert('Số lượng vượt quá giới hạn trong kho. Giới hạn tối đa bạn có thể thêm  là ' +
                            maxQuantity);
                        this.value = maxQuantity; // Trả về số lượng tối đa
                        newQuantity = maxQuantity; // Cập nhật lại số lượng để gửi lên server
                    }
            ...
            function updateCartTotal() {
                ...
                document.querySelectorAll('.total-price').forEach(function(priceElement) {
                    const priceText = priceElement.textContent.replace(/\D/g, ''); // Loại bỏ dấu phân cách
                    total += parseInt(priceText); // Cộng tổng
                });

                // Cập nhật giá trị tổng tiền trong giỏ hàng
