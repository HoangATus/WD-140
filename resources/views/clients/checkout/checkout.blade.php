                                                    ...
                                                    <div class="delivery-address-box">
                                                        <div>
                                                            ...
                                                            <ul class="delivery-address-detail">
                                                                ...
                                                                <li>
                                                                    <h6 class="text-content"><span
                                                                            class="text-title">Mã bưu chính :</span>
                                                                        +380</h6>
                                                                </li>
                                                            ...
                                                            <div class="shipment-detail">
                                                                <div
                                                                    ...
                                                                    <label class="form-check-label"
                                                                        for="standard">Tùy chọn giao hàng tiêu chuẩn
                                                                        </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="delivery-category">
                                                            <div class="shipment-detail">
                                                                <div
                                                                    ...
                                                                    Tùy chọn giao hàng trong tương lai</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="delivery-items">
                                                                    <div>
                                                                        <h5 class="items text-content"><span>3
                                                                                Mục</span>@
                                                                            $693.48</h5>
                                                                        <h5 class="charge text-content">Phí giao hàng
                                                                            $34.67
                                            ...
                                            <div class="accordion accordion-flush custom-accordion"
                                                ...
                                                <div class="accordion-item">
                                                    ...
                                                    <div id="flush-collapseFour"
                                                        ...
                                                        <div class="accordion-body">
                                                            <p class="cod-review">Thanh toán kỹ thuật số bằng SMS Pay Link. 
                                                                Tiền mặt có thể không được chấp 
                                                                nhận ở những khu vực hạn chế COVID.<a href="javascript:void(0)">Tìm hiểu thêm.</a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="row g-2">
                                                                <div class="col-12">
                                                                    <div class="payment-method">
                                                                        <div
                                                                            ...
                                                                            <label for="credit2">Nhập số thẻ tín dụng và thẻ ghi nợ
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="button-group mt-0">
                                                                    <ul>
                                                                        <li>
                                                                            <button
                                                                                class="btn btn-light shopping-button">Hủy bỏ</button>
                                                                        </li>

                                                                        <li>
                                                                            <button class="btn btn-animation">Sử dụng thẻ này
                                                                                </button>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                ...
                                                <div class="accordion-item">
                                                        ...
                                                        <div class="accordion-button collapsed"
                                                            ...
                                                            <div class="custom-form-check form-check mb-0">
                                                                <label class="form-check-label" for="banking"><input
                                                                        class="form-check-input mt-0" type="radio"
                                                                        name="flexRadioDefault" id="banking">Ngân hàng trực tuyến
                                                                    </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                                        data-bs-parent="#accordionFlushExample">
                                                        <div class="accordion-body">
                                                            <h5 class="text-uppercase mb-4">Chọn Ngân hàng của bạn
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="custom-form-check form-check">
                                                                        <input class="form-check-input mt-0"
                                                                            ...
                                                                            id="bank1">
                                                                        <label class="form-check-label"
                                                                            for="bank1">Ngân hàng Công thương
                                                                            </label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="custom-form-check form-check">
                                                                        <input class="form-check-input mt-0"
                                                                            ...
                                                                            id="bank2">
                                                                        <label class="form-check-label"
                                                                            for="bank2">Ngân hàng Nông nghiệp</label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="custom-form-check form-check">
                                                                        <input class="form-check-input mt-0"
                                                                            type="radio" name="flexRadioDefault"
                                                                            id="bank3">
                                                                        <label class="form-check-label" for="bank3">Ngân hàng Hoa Kỳ
                                                                            </label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="custom-form-check form-check">
                                                                        <input class="form-check-input mt-0"
                                                                            ...
                                                                            id="bank4">
                                                                        <label class="form-check-label"
                                                                            for="bank4">Ngân hàng Xây dựng</label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="custom-form-check form-check">
                                                                        <input class="form-check-input mt-0"
                                                                            ...
                                                                            id="bank6">
                                                                        <label class="form-check-label"
                                                                            for="bank6">Ngân hàng JPMorgan Chase & Co.</label>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="select-option">
                                                                        <div class="form-floating theme-form-floating">
                                                                            <select
                                                                                ...
                                                                                <option value="hsbc">Tập đoàn HSBC
                                                                                </option>
                                                                            ...
                                                                            <label>Chọn ngân hàng khác</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="accordion-item">
                                                        ...
                                                        <div class="accordion-button collapsed"
                                                            ...
                                                            <div class="custom-form-check form-check mb-0">
                                                                <label class="form-check-label" for="wallet"><input
                                                                        class="form-check-input mt-0" type="radio"
                                                                        name="flexRadioDefault" id="wallet">Ví của tôi
                                                                    </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div id="flush-collapseThree" class="accordion-collapse collapse"
                                                        data-bs-parent="#accordionFlushExample">
                                                        <div class="accordion-body">
                                                            <h5 class="text-uppercase mb-4">Chọn ví của bạn
                                                            </h5>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="custom-form-check form-check">
                                                                        <label class="form-check-label"
                                                                            for="amazon"><input
                                                                                ...
                                                                                type="radio" name="flexRadioDefault"
                                                                                id="amazon">Thanh toán Amazon</label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="custom-form-check form-check">
                                                                        <input class="form-check-input mt-0"
                                                                            ...
                                                                            id="gpay">
                                                                        <label class="form-check-label"
                                                                            for="gpay">Thanh toán Google</label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="custom-form-check form-check">
                                                                        <input class="form-check-input mt-0"
                                                                            ...
                                                                            id="paytm">
                                                                        <label class="form-check-label"
                                                                            for="paytm">Thanh toán Paytm</label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="custom-form-check form-check">
                                                                        <input class="form-check-input mt-0"
                                                                            type="radio" name="flexRadioDefault"
                                                                            id="jio">
                                                                        <label class="form-check-label" for="jio">Tiền JIO
                                                                            </label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="custom-form-check form-check">
                                                                        <input class="form-check-input mt-0"
                                                                            ...
                                                                            id="free">
                                                                        <label class="form-check-label"
                                                                            for="free">Nạp tiền miễn phíx`</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <div class="right-side-summery-box">
                        ...
                        <div class="checkout-offer">
                            ...
                            <ul class="offer-detail">
                                ...
                                <li>
                                    <p>combo: Hạt điều Royal Cashew Californian, Extra Bold 100 gm + BB Royal Honey 500 gm</p>
                                </li>
                            </ul>
                        </div>
